...
class NodeMLN:
    ...
    def google_title_contain_aff_word(self):
        ...
        for aff_word in self.aff_word_list:
            if aff_word in self.google_title:
    ...
    def google_content_contain_aff_word(self):
        contain_aff_word = False
        for aff_word in self.aff_word_list:
            if aff_word in self.google_content:
                contain_aff_word = True
                break
    ...
    def google_content_contain_all_first_char(self):
        ...
        return is_contain_all_first_char, self.grounding_string_unary('google_content_contain_all_first_char', is_contain_all_first_char)
